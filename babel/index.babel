//TODO : only allow percent to be taken once?
//TODO : show stored operator/operand on left end of screen while user enters other operand
...
var calculator = {
  ...
  state : {
    ...
    last_operator : null,
    last_operand : null,
    disable_input : false, //disables numbers, decimal, and the '%' operator when an answer is shown
  },
